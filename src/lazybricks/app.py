...
Usage:
    ...
    lazybricks setup billing      # Configure billing extension
"""
...
def _setup_billing(client: DatabricksClient) -> None:
    ...
    print()
    print("=" * 50)
    print("  LazyBricks — Billing Extension Setup")
    print("=" * 50)
    print()
    ...
    # Write config
    config_dir = Path.home() / ".lazybricks"
    ...
    with open(config_path, "w") as f:
        f.write("# LazyBricks Configuration\n\n")
        f.write("[extensions]\n")
    ...
    print()
    print("Run 'lazybricks' and press 'b' to open Billing.")
    print()
