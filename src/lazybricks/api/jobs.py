...
All methods return normalized model objects from lazybricks.models.job.
"""
...
from lazybricks.models.job import JobSummary, RunDetail, RunResult, RunState, RunSummary, TaskSummary
